  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <section className="flex flex-col md:flex-row-reverse items-center gap-16 px-16 pt-24 mt-12">

          <div className="w-full md:w-1/2 flex justify-center">
            <img
              src={productDetails?.image || "/placeholder.jpg"}
              alt={productDetails?.name || "Product Image"}
              className="w-full max-w-md rounded-2xl object-contain shadow-xl transition-transform duration-1000 hover:scale-105"
            />
          </div>
              ...
              <div key={product.slug} className="border rounded-xl p-4 shadow-md transition-transform duration-1000 hover:scale-105 flex flex-col items-center">
                ...
                <button onClick={() => {
                  ...
                  window.scrollTo({ top: 0, behavior: "smooth" });
                    ...
                    className="mt-3 mb-4 bg-primary-buttons text-white py-2 px-4 rounded-lg hover:bg-primary hover:text-black transition-transform duration-1000 flex justify-center">View Details</button>
